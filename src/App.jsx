  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="w-full text-center mb-12">
        <h2 className="text-4xl md:text-7xl gold-text font-black w-full flex items-center justify-center gap-2 md:gap-4 px-2">
          <span className="hidden md:inline" role="img" aria-label="trophy">🏆</span>
          SDGs 機智問答優勝榜
          <span className="hidden md:inline" role="img" aria-label="trophy">🏆</span>
        </h2>
      </div>
